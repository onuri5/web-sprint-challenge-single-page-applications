...
Allow the developer to acces Match data without having to render <Route>.
1. How would you explain form validation to someone who has never programmed before?
Form validation is blocking the user from moving forward/to the next section until they have completed all required fields to do so.
1. In 1-2 sentences, define end to end testing.
End to end testing is implementation of tests that test the functionality/performance of web page as much as possible.
